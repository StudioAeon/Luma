...
namespace Luma {
	...
	void EditorLayer::OnAttach()
	{
		...
		m_QuadShader = Shader::Create("Resources/Shaders/quad.glsl");
		m_HDRShader = Shader::Create("Resources/Shaders/hdr.glsl");

		m_SphereMesh.reset(new Mesh("Resources/Models/Sphere1m.fbx"));
		m_PlaneMesh.reset(new Mesh("Resources/Models/Plane1m.obj"));

		m_GridShader = Shader::Create("Resources/Shaders/Grid.glsl");
	...
	// Forward declarations to ensure proper overload resolution
