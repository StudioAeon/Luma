...
namespace Luma {
	...
	ContentBrowserPanel::ContentBrowserPanel()
	{
		...
		m_FileTex = AssetManager::GetAsset<Texture2D>("Resources/Editor/file.png");
		m_AssetIconMap[""] = AssetManager::GetAsset<Texture2D>("Resources/Editor/folder.png");
		m_AssetIconMap["fbx"] = AssetManager::GetAsset<Texture2D>("Resources/Editor/fbx.png");
		m_AssetIconMap["obj"] = AssetManager::GetAsset<Texture2D>("Resources/Editor/obj.png");
		m_AssetIconMap["wav"] = AssetManager::GetAsset<Texture2D>("Resources/Editor/wav.png");
		m_AssetIconMap["png"] = AssetManager::GetAsset<Texture2D>("Resources/Editor/png.png");
		m_AssetIconMap["lsc"] = AssetManager::GetAsset<Texture2D>("Resources/Editor/luma.png");

		m_BackbtnTex = AssetManager::GetAsset<Texture2D>("Resources/Editor/btn_back.png");
		m_FwrdbtnTex = AssetManager::GetAsset<Texture2D>("Resources/Editor/btn_fwrd.png");
				...
				ImGui::BeginChild("Scrolling");
				{
					...
					if (ImGui::BeginPopupContextWindow(nullptr, ImGuiPopupFlags_MouseButtonRight | ImGuiPopupFlags_NoOpenOverItems))
					{
						if (ImGui::BeginMenu("Create"))
						{
							...
							{
								bool created = FileSystem::CreateDirectory(m_CurrentDirectory->FilePath + "/New Folder");
							...
							{
								LM_CORE_INFO("Creating Scene...");
							}

							if (ImGui::MenuItem("Prefab"))
							{
								LM_CORE_INFO("Creating Prefab...");
							}
	...
	void ContentBrowserPanel::HandleRenaming(Ref<Asset>& asset)
	{
		...
		if (m_RenamingSelected)
		{
			...
			{
				LM_CORE_INFO("Renaming to {0}", m_RenameBuffer);
