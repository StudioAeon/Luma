...
# error Unsupported compiler
			...
			{
				// don't look for "::" namespace end past template arguments start
				constexpr auto namespace_search_end = name.find_first_of('<');

				// this breaks when type has template with namespaced types, therefore we need namespace_search_end
				constexpr auto new_start = name.find_last_of("::", namespace_search_end);
