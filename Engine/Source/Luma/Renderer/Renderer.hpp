...
namespace Luma {
	...
	namespace Utils {
		...
		inline void DumpGPUInfo()
		{
			...
			LM_CORE_TRACE_TAG("Renderer", "GPU Info:");
			LM_CORE_TRACE_TAG("Renderer", "  Vendor: {0}", caps.Vendor);
			LM_CORE_TRACE_TAG("Renderer", "  Device: {0}", caps.Device);
			LM_CORE_TRACE_TAG("Renderer", "  Version: {0}", caps.Version);
		}
