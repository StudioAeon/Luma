...
#include "Luma/ImGui/VulkanImGui.cpp"
...
namespace Luma {
	...
	void VulkanImGuiLayer::OnAttach()
	{
		...
		Renderer::Submit([instance]()
		{
			...
			init_info.DescriptorPoolSize = 0; // Using DescriptorPool above
			...
			init_info.PipelineInfoForViewports.RenderPass = vulkanContext->GetSwapChain().GetRenderPass();
