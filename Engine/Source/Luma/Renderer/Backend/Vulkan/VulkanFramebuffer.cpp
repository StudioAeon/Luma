...
namespace Luma {
		...
		: m_Specification(spec)
	{
		...
		LM_CORE_ASSERT(spec.Attachments.Attachments.size());
	...
	{
		LM_CORE_TRACE("VulkanFramebuffer::RT_Invalidate");
		...
		for (auto attachmentSpec : m_Specification.Attachments.Attachments)
		{
			...
			{
				LM_CORE_ASSERT(!m_Specification.ExistingImage, "Not supported for color attachments");
